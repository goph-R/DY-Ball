...
return {
    display = {
        -- Portrait, 9:16 — the design aspect. 720x1280 is the design space
        -- itself but does not fit a 1080p desktop, and the fit in view.lua
        -- handles any window shape anyway: a wider window pillarboxes.
        width      = 540,
        height     = 960,
        fullscreen = false,
